...
/***/
    (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
        /* harmony import */
        var swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/ __webpack_require__.n(swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0__);
...
var DefaultCard = document.querySelectorAll('.make-default-action');

if (DefaultCard) {
    DefaultCard.forEach(function (inviteBrand) {
        inviteBrand.addEventListener('click', function (e) {
            e.preventDefault();
            document.querySelector('.make-default-modal').classList.add('active');
        });
    });
}

var CardRemove = document.querySelectorAll('.card-remove-action');

if (CardRemove) {
    CardRemove.forEach(function (inviteBrand) {
        inviteBrand.addEventListener('click', function (e) {
            e.preventDefault();
            document.querySelector('.delete-card-modal').classList.add('active');
        });
    });
}

var RemoveList = document.querySelectorAll('.remove-products-action');

if (RemoveList) {
    RemoveList.forEach(function (inviteBrand) {
        inviteBrand.addEventListener('click', function (e) {
            e.preventDefault();
            document.querySelector('.remove-products-list-modal').classList.add('active');
        });
    });
}
...
var Congratulations = document.querySelectorAll('.congratulations-action');

if (Congratulations) {
    Congratulations.forEach(function (inviteBrand) {
        inviteBrand.addEventListener('click', function (e) {
            e.preventDefault();
            document.querySelector('.congratulations-modal').classList.add('active');
        });
    });
}
...
var apopups = document.querySelectorAll('.sd_alert');

if (apopups) {
    apopups.forEach(function (sd_alert) {
        var closes = sd_alert.querySelectorAll('.popup-close');
        closes.forEach(function (close) {
            close.addEventListener('click', function (e) {
                e.preventDefault();
                sd_alert.classList.remove('active');
            });
        });
    });
}
