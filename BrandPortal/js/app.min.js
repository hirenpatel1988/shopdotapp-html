...
//Single Product modal end
  ...
  var inviteBrands = document.querySelectorAll('.invite-retailer');
...
//***********************  BMR: Invite retailer code ****************************************
   var inviteRetailer = document.querySelectorAll('.invite-retailer');

  if (inviteRetailer) {
    inviteRetailer.forEach(function (inviteBrand) {
      inviteBrand.addEventListener('click', function (e) {
        e.preventDefault();
        document.querySelector('.popup-invite').classList.add('active');
      });
...
//Read More code
      ...
      $(document).ready(function(){
          //event for edit product radio button click
        $(document).on("click", ".pe_radio", function(){
            $(document).find(".pe").removeClass("active");
            $(this).parents(".pe").addClass("active");
        });
        showMore();
        ...
        if ( $(window).width() < 992) {     
          $(".dropdown_body").hide();          
            ...
            $('.menu_link').on('click', function(){
              if($(this).parents(".dropdown").find(".dropdown_body").is(':visible')) {
                $(this).parents(".dropdown").find(".dropdown_body").css({'opacity' : 0,'visibility' : 'hidden', 'z-index': 0});       
                $(this).parents(".dropdown").find(".dropdown_body").hide();
                $(this).parents(".dropdown").find("svg.icon").find("use").attr("xlink:href", "images/sprite.svg#icon-chevron--down");
              }
              else {
                $(this).parents(".dropdown").find(".dropdown_body").css({'opacity' : 1,'visibility' : 'visible'});
                $(this).parents(".dropdown").css('z-index', 2);
                $(this).parents(".dropdown").find(".dropdown_body").show();
                $(this).parents(".dropdown").find("svg.icon").find("use").attr("xlink:href", "images/sprite.svg#icon-chevron--up");
              }
            }); 
        ...
        $(document).mouseup(function(event) {
          ...
          if (!menulink.is(target) && $('.dropdown').has(target).length === 0) {
            $(" .menu_item .dropdown").find(".dropdown_body").css({'opacity' : 0,'visibility' : 'hidden', 'z-index': 0}); 
            $(" .menu_item .dropdown").find(".dropdown_body").hide();
            $(" .menu_item .dropdown").find("svg.icon").find("use").attr("xlink:href", "images/sprite.svg#icon-chevron--down");
          }
        });
        ...
        $(document).keyup(function (e) {
          ...
          if(code == 9) {
            if(!$(".menu_link").is(e.target) && $('.dropdown').has(target).length === 0)  {
              $(" .menu_item .dropdown").find(".dropdown_body").css({'opacity' : 0,'visibility' : 'hidden', 'z-index': 0}); 
              $(" .menu_item .dropdown").find(".dropdown_body").hide();
              $(" .menu_item .dropdown").find("svg.icon").find("use").attr("xlink:href", "images/sprite.svg#icon-chevron--down");
            }
...
/******************** START multiselect box with checkbox ********************/
...
function showCheckboxes(selectId) {
  var checkboxes = document.getElementById(selectId);
  // if (!expanded) {
...
//    var containers1 = document.getElementsByClassName('select-list')[0];
//    var containers2 = document.getElementsByClassName('select-list')[1];
//    var containers3 = document.getElementsByClassName('select-list')[2];
//    if ($(e.target).attr("class") !== "overSelect" && containers1 !== null &&  !containers1.contains(e.target) && !containers2.contains(e.target) && !containers3.contains(e.target)) {
//      $(document).find(".select-list").hide();
//    }
});

$(document).on("click", '.overSelect', function(){
  var id = $(this).data('selectid');
  $(document).find(".select-list:not(#"+id+")").addClass('hide').hide();
  $("#"+id).toggleClass('hide');
  if ($(document).find("#"+id).hasClass('hide')) {
    $("#"+id).hide();
  } else {
    $("#"+id).show();
  }
...
$(document).on("click", function(e){
    if(!$(event.target).hasClass("overSelect") && !$(event.target).parents( ".select-options" ).length) {
        $(".select-options").addClass('hide').hide();
    } 
})
/******************** END multiselect box with checkbox ********************/

/******************** close the notify bottom bar js ********************/
const bN = document.querySelector('.bottom-notify')
  if (bN) {
    bN.querySelector('.bottom-notify-close').addEventListener('click', () => {
      bN.classList.remove('active')
    })
  }
/******************** close the notify bottom bar js end ********************/

/******************** select dropdown change js ********************/
$(function() {
  $(".products_body .select select").change(function(){
    var selectedOption = $(this).children("option:selected").val();
    alert("Your selected option is - " + selectedOption);
  });
});
/******************** select dropdown change js end********************/
...
//  }
  ...
  var DeleteUser = document.querySelectorAll('.edit-action');

  if (DeleteUser) {
    DeleteUser.forEach(function (inviteBrand) {
      inviteBrand.addEventListener('click', function (e) {
        e.preventDefault();
        document.querySelector('.edit-user-modal').classList.add('active');
      });
    });
  }
  ...
  var DeleteUser = document.querySelectorAll('.variants-modal-action');

  if (DeleteUser) {
    DeleteUser.forEach(function (inviteBrand) {
      inviteBrand.addEventListener('click', function (e) {
        e.preventDefault();
        document.querySelector('.my-product-modal').classList.add('active');
      });
    });
  }

  var DeleteUser = document.querySelectorAll('.add-retailer');

  if (DeleteUser) {
    DeleteUser.forEach(function (inviteBrand) {
      inviteBrand.addEventListener('click', function (e) {
        e.preventDefault();
        document.querySelector('.pd-retailer-modal').classList.add('active');
      });
    });
  }

  var DeleteUser = document.querySelectorAll('.add-category');
  ...
  var DeleteUser = document.querySelectorAll('.add-tags');

  if (DeleteUser) {
    DeleteUser.forEach(function (inviteBrand) {
      inviteBrand.addEventListener('click', function (e) {
        e.preventDefault();
        document.querySelector('.tags-modal').classList.add('active');
      });
    });
  }
...
var passShows = document.querySelectorAll('.password-show');

$(function() {
  passShows.forEach(function (passShow) {
    passShow.addEventListener('click', function () {
      if (passShow.classList.contains('active')) {
        passShow.classList.remove('active');
        passShow.parentElement.querySelector('input.password').setAttribute('type', 'password');
        return;
      }

      passShow.classList.add('active');
      passShow.parentElement.querySelector('input.password').setAttribute('type', 'text');
    });
  });
});